...
This script is intentionally separate from `exp_rank_flip.py` to avoid
changing any previously-run experiments. It can optionally reuse an existing JSON
from `exp_rank_flip.py` to avoid re-running DECODE/REAL.
"""
...
def main() -> None:
    ...
    ap.add_argument("--base_json", type=str, default="", help="Optional existing JSON from exp_rank_flip.py to reuse DECODE/REAL/TRAD-A results.")
