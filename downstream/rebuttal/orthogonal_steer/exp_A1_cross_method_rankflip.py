...
# -*- coding: utf-8 -*-
"""
exp_A1_cross_method_rankflip.py
...
Typical usage
-------------
CUDA_VISIBLE_DEVICES=0 python exp_A1_cross_method_rankflip.py \
...
Under out_dir/, you get:
  ...
  summary.md  (main rebuttal-ready table)
"""
...
def main():
    ...
    ap.add_argument("--out_dir", type=str, default="results/A1_cross_method")
