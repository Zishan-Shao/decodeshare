...
Examples:
  python summarize_patchback_results.py --dir results/patchback_transfer/runs_layer10_seed123 --pattern "*.json"
  python summarize_patchback_results.py --dir results --pattern "**/*.json" --recursive
  python summarize_patchback_results.py --dir results --pattern "**/*.json" --recursive --no_dedupe
"""
