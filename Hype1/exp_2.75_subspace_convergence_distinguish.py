# -*- coding: utf-8 -*-
"""
exp2_subspace_convergence_sharedness.py
...
CUDA_VISIBLE_DEVICES=0 python exp_2.75_subspace_convergence_distinguish.py \
...
def load_prompts(loader: str, n_prompts: int, seed: int) -> Dict[str, List[str]]:
    ...
    if loader == "full":
        try:
            import prove_sharedness_decode_full as full  # your wrapper
