...
# Output dirs
# -----------------------------
mkdir -p outputs/energy_kmatch_alpha_sweep

# -----------------------------
# Config
# -----------------------------
SCRIPT="experiments/02_decode_ablation/run_energy_kmatch_reasoning.py"
...
OUT_PREFIX="outputs/energy_kmatch_alpha_sweep/${MODEL_TAG}_L${LAYER}_seed${SEED}_ts${TS}"
