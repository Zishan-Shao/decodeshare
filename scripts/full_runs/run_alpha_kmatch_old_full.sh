...
# Output dirs
# -----------------------------
OUT_ALPHA_DIR="${ROOT}/outputs/alpha_sweep_decode_aligned"
OUT_KMATCH_DIR="${ROOT}/outputs/kmatch"
LOG_DIR="${ROOT}/outputs/logs_disturb_energy_kmatch"
...
run_one () {
  ...
  CUDA_VISIBLE_DEVICES=0 python run_energy_kmatch_generation.py \
