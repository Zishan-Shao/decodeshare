# -*- coding: utf-8 -*-
"""prefill_vs_decode_alignment_experiment.py
...
CUDA_VISIBLE_DEVICES=0 python prefill_vs_decode_alignment_experiment.py \
...
Example (greedy generation everywhere):

CUDA_VISIBLE_DEVICES=1 python prefill_vs_decode_alignment_experiment.py \
  --model meta-llama/Llama-2-7b-chat-hf --device cuda --dtype fp32 \
  --layer 10 --n_prompts 128 --eval_n 256 \
  --calib_decode_max_new_tokens 128 --per_task_max_states 20000 \
  --pca_var 0.95 --tau 0.001 --m_shared all \
...
CUDA_VISIBLE_DEVICES=0 python prefill_vs_decode_alignment_experiment.py \
  ...
  --pca_var 0.95 --tau 0.001 --m_shared all \
  --do_generation 1 \
  --gen_decoding sample --gen_temperature 0.7 --gen_top_p 0.9 --gen_top_k 0 \
  --gen_seed 12345 --gen_max_new_tokens 256


When --do_generation 1, the --fc_* forced-choice options (warmup, fc_answer_prefix, etc.) are effectively ignored.
