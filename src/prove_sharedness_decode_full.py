...
def _parse_max_memory_map(spec: str) -> Dict[Any, str]:
    """
    Parse strings like:
      "0:95,1:110,2:80,cpu:64"
    into:
      {0: "95GiB", 1: "110GiB", 2: "80GiB", "cpu": "64GiB"}
    """
    out: Dict[Any, str] = {}
...
def main():
    ...
    ap.add_argument("--max_dim", type=int, default=8192)
    ...
    try:
        ...
        print(
            f"[Env] device_map={args.device_map!r} "
            f"max_memory_per_gpu_gb={args.max_memory_per_gpu_gb} "
            f"cpu_offload_gb={args.cpu_offload_gb} "
            f"max_memory_map={args.max_memory_map!r}"
        )
