...
def main():
    ...
    ap.add_argument("--tasks", type=str, default="boolq,rte,sst2",
                    help="Comma-separated: boolq,rte,sst2,(optional)qnli,imdb or 'all'")
    ...
    ap.add_argument("--basis_source", type=str, default="neutral", choices=["neutral", "task"])
