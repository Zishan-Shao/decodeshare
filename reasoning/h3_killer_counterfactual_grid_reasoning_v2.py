...
def main():
    ...
    print(
        f"[Env] model={args.model} device={args.device} dtype={args.model_dtype} "
        f"device_map={args.device_map!r} max_memory_per_gpu_gb={args.max_memory_per_gpu_gb} "
        f"cpu_offload_gb={args.cpu_offload_gb} max_memory_map={args.max_memory_map!r}"
    )
