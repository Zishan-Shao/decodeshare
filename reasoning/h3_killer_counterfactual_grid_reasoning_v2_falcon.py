...
def main():
    # NOTE: disallow abbreviated long options so typos like
    #   --calib_decode_max_new_toke ns 512
    # don't get silently interpreted as --calib_decode_max_new_tokens with value "ns".
