...
CUDA_VISIBLE_DEVICES=1 python run_full_benchmark.py   --model google/gemma-3-12b-it   --device cuda   --model_dtype fp32   --layer 10   --n_prompts 128   --calib_max_new_tokens 128   --max_prompt_len 512   --per_task_max_states 20000   --tau 0.001   --m_shared all   --null_perm_trials 2000   --null_scramble_trials 100   --out_json results/full_benchmark/gemma3_exist.json   --out_txt  results/full_benchmark/gemma3_exist.txt

CUDA_VISIBLE_DEVICES=1 python run_full_benchmark.py   --model meta/llama-2-7b-chat-hf   --device cuda   --model_dtype fp32   --layer 10   --n_prompts 128   --calib_max_new_tokens 128   --max_prompt_len 512   --per_task_max_states 20000   --tau 0.001   --m_shared all   --null_perm_trials 2000   --null_scramble_trials 100   --out_json results/full_benchmark/llama2-7b-chat-hf_exist.json   --out_txt  results/full_benchmark/llama2-7b-chat-hf_exist.txt

CUDA_VISIBLE_DEVICES=1 python run_full_benchmark.py   --model Qwen/Qwen2.5-7B-Instruct   --device cuda   --model_dtype fp32   --layer 10   --n_prompts 128   --calib_max_new_tokens 128   --max_prompt_len 512   --per_task_max_states 20000   --tau 0.001   --m_shared all   --null_perm_trials 2000   --null_scramble_trials 100   --out_json results/full_benchmark/Qwen2.5-7B-Instruct_exist.json   --out_txt  results/full_benchmark/Qwen2.5-7B-Instruct_exist.txt
